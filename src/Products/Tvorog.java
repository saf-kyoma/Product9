...
public class Tvorog extends Product implements Perishable, FatContentable, NetGrossWeightable
{
    ...
    public Tvorog(int id, String name, String upc, String manufacturer, double price, int quantity,
